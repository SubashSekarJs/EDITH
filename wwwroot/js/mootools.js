...
//updated 8/27/09 sshepar3 - Tips was moved to Tooltips.js
...
this.fireEvent("onDragComplete",[this.active,this.ghost]);}this.fireEvent("onComplete",this.active);}});Sortables.implement(new Events,new Options);var Group=new Class({initialize:function(){this.instances=$A(arguments);
